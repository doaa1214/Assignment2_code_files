...
function Vertex(v)
{
	...
	// vertex can be marked visited or "seen"
...
function Graph()
{
	...
	// true if digraph, false otherwise (default undirected)
	this.weighted = false;
	
	// true if weighted graph, false otherwise (default unweighted)
	this.dfs_push = [];
	...
	// BFS order output
	this.label = "";
	// identification string to label graph
